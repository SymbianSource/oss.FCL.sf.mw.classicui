...
#ifndef C_TESTDOMVOLUMEPOPUPCONTAINER_H
#define C_TESTDOMVOLUMEPOPUPCONTAINER_H
#include <coecntrl.h>
    /**
     * container class
     */
class CVolumePopupContainer : public CCoeControl
    {
public:
    // constructors and destructor
    CVolumePopupContainer();
...
#endif /*C_TESTDOMVOLUMEPOPUPCONTAINER_H*/
