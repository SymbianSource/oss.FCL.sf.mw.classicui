...
#ifndef C_TESTSDKTPCONTAINER_H
#define C_TESTSDKTPCONTAINER_H
...
* container class
*/
class CTestSDKTPContainer: public CCoeControl
    {
public: 
// constructor and destructor
     ...
     * Destructor
     */
    virtual ~CTestSDKTPContainer();
    /**
    void handleevent(TPointerEvent aEvent){CCoeControl::HandlePointerEventL( aEvent ); }
     * Symbian 2nd constructor
     */
    void ConstructL( const TRect& aRect );
    
    /*
     * Test HandlePointerEventL
     * */
    void TransferEventL( TPointerEvent aEvent );
