...
#ifndef C_TESTSDLSLIDERCONTAINER_H
#define C_TESTSDLSLIDERCONTAINER_H
#include <coecntrl.h>
    /**
     * container class
     */
class CSliderContainer : public CCoeControl
    {
public:
...
#endif /*C_TESTSDLSLIDERCONTAINER_H*/
