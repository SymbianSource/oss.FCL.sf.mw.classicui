...
ODE_API IMPORT_C void dSetZero (dReal *a, int n);
ODE_API IMPORT_C void dSetValue (dReal *a, int n, dReal value);
...
ODE_API IMPORT_C dReal dDot (const dReal *a, const dReal *b, int n);
...
ODE_API IMPORT_C void dMultiply0 (dReal *A, const dReal *B, const dReal *C, int p,int q,int r);
ODE_API IMPORT_C void dMultiply1 (dReal *A, const dReal *B, const dReal *C, int p,int q,int r);
ODE_API IMPORT_C void dMultiply2 (dReal *A, const dReal *B, const dReal *C, int p,int q,int r);
...
ODE_API IMPORT_C int dFactorCholesky (dReal *A, int n);
...
ODE_API IMPORT_C void dSolveCholesky (const dReal *L, dReal *b, int n);
...
ODE_API IMPORT_C int dInvertPDMatrix (const dReal *A, dReal *Ainv, int n);
...
ODE_API IMPORT_C int dIsPositiveDefinite (const dReal *A, int n);
 ...
 * d.
 */
ODE_API IMPORT_C void dFactorLDLT (dReal *A, dReal *d, int n, int nskip);
 ...
 */
ODE_API IMPORT_C void dSolveL1 (const dReal *L, dReal *b, int n, int nskip);
 ...
 * the leading dimension of L is `nskip'.
 */
ODE_API IMPORT_C void dSolveL1T (const dReal *L, dReal *b, int n, int nskip);


/* in matlab syntax: a(1:n) = a(1:n) .* d(1:n) */

ODE_API IMPORT_C void dVectorScale (dReal *a, const dReal *d, int n);
...
ODE_API IMPORT_C void dSolveLDLT (const dReal *L, const dReal *d, dReal *b, int n, int nskip);
 ...
 */
ODE_API IMPORT_C void dLDLTAddTL (dReal *L, dReal *d, const dReal *a, int n, int nskip);
 ...
 */
ODE_API IMPORT_C void dLDLTRemove (dReal **A, const int *p, dReal *L, dReal *d,
 ...
 */
ODE_API IMPORT_C void dRemoveRowCol (dReal *A, int n, int nskip, int r);
