...
#ifndef C_TESTSDKIFCONTAINER_H
#define C_TESTSDKIFCONTAINER_H
#include <coecntrl.h>
    /**
     * container class
     */
class CInputFrameContainer : public CCoeControl
    {
public:
