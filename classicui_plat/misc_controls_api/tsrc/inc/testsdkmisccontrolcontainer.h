...
#ifndef C_TESTSDKMISCCONTROLCONTAINER_H
#define C_TESTSDKMISCCONTROLCONTAINER_H
#include <coecntrl.h>
    /**
     * container class
     */
class CMiscControlsContainer : public CCoeControl
    {
public:
    // constructors and destructor
    CMiscControlsContainer();
     ...
     * Destructor
     */
    virtual ~CMiscControlsContainer();
...
#endif /*C_TESTSDKMISCCONTROLCONTAINER_H*/
