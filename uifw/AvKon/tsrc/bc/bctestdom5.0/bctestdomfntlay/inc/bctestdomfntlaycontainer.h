...
* Contributors:
*
* Description:  container of control 
*
*/


#ifndef C_CBCTESTDOMFNTLAYCONTAINER_H
#define C_CBCTESTDOMFNTLAYCONTAINER_H
...
* container class
*/
class CBCTestDomFntlayContainer: public CCoeControl
    {
public: // constructor and destructor
     ...
     */
    CBCTestDomFntlayContainer();
    
    /**
     * Destructor
     */
    virtual ~CBCTestDomFntlayContainer();
...
#endif // C_CBCTESTDOMFNTLAYCONTAINER_H
