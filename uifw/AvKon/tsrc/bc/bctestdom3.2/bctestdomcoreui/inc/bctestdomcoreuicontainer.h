...
#ifndef C_CBCTESTDOMCOREUICONTAINER_H
#define C_CBCTESTDOMCOREUICONTAINER_H
...
* container class
*/
class CBCTestDomCoreUiContainer: public CCoeControl
    {
public: // constructor and destructor
     ...
     */
    CBCTestDomCoreUiContainer();
    
    /**
     * Destructor
     */
    virtual ~CBCTestDomCoreUiContainer();
