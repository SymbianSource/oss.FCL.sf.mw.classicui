...
#ifndef C_CBCTESTDOMCDLCONTAINER_H
#define C_CBCTESTDOMCDLCONTAINER_H
...
* container class
*/
class CBCTestDomCdlContainer: public CCoeControl
    {
public: // constructor and destructor
     ...
     */
    CBCTestDomCdlContainer();
    
    /**
     * Destructor
     */
    virtual ~CBCTestDomCdlContainer();
