...
#ifndef C_TESTSDKNOTESCONTROL_H
#define C_TESTSDKNOTESCONTROL_H
 ...
 */
class CTestNotesControl : public CCoeControl
    {
public:
    /**
     * Two-phased constructor.
     */
    static CTestNotesControl* NewL();
